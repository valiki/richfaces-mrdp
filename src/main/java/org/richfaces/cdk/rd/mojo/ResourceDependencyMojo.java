...
public  class ResourceDependencyMojo extends AbstractMojo {
  ...
  protected List remoteRepositories;
	...
	public void execute() throws MojoExecutionException, MojoFailureException {
		try {
			...
			if(contextClassLoader != null) {
				...
				if (beforeScriptIncludes!=null && beforeScriptIncludes.size()>0) {
                    scripts.removeAll(beforeScriptIncludes);
                }
	...
	protected ClassLoader createClassLoader() throws Exception {
		...
		//the priority should be first resources and classes from the project and only after that from the jars
